...
my.Simu <- function(s){
  ...
  index_2=which(final_post_model$w_change_list[[1]]!=0)
  eva=Eva_variable_selection(index_2,b1)
  
  variable_selection_mat[index_2] =1
  variable_selection_mat[setdiff(1:100,index_2)] =0
  ...
  final_result=list(pre_eva=pre_eva,eva=eva,index=index_2,variable_selection_mat=variable_selection_mat,pre_gmeans=GM,final_ita=kargs$final_eta)
...
ho_variable_selection_result_2=ho_variable_selection_result
ho_prediction_result_2=ho_prediction_result
seperate_gmeans_2=seperate_gmeans
variable_selection_result_2=variable_selection_result

ho_variable_selection_result_2
ho_prediction_result_2
variable_selection_result_2
seperate_gmeans_2

write.table(ho_variable_selection_result_2,file="ho_variable_selection_result_2.txt")
write.table(ho_prediction_result_2,file="ho_prediction_result_2.txt")
write.table()
