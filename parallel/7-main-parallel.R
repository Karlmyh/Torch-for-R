...
my.Simu <- function(s){
  ...
  index_7=which(final_post_model$w_change_list[[1]]!=0)
  eva=Eva_variable_selection(index_7,b1)
  
  variable_selection_mat[index_7] =1
  variable_selection_mat[setdiff(1:100,index_7)] =0
  ...
  final_result=list(pre_eva=pre_eva,eva=eva,index=index_7,variable_selection_mat=variable_selection_mat,pre_gmeans=GM,final_ita=kargs$final_eta)
...
ho_variable_selection_result_7=ho_variable_selection_result
ho_prediction_result_7=ho_prediction_result
seperate_gmeans_7=seperate_gmeans
variable_selection_result_7=variable_selection_result

ho_variable_selection_result_7
ho_prediction_result_7
variable_selection_result_7
seperate_gmeans_7
